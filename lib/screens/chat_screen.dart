...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    FireBaseHelper().updateUserStatus("Online",
  ...
  void dispose() {
    ...
    FireBaseHelper().updateUserStatus(
        FieldValue.serverTimestamp(), _appProvider.auth.currentUser!.uid);
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () {
                  notifyUserWithCall(
                      "Calling from ${Provider.of<MyProvider>(context, listen: false).auth.currentUser!.displayName}",
                      Provider.of<MyProvider>(context, listen: false)
                          .peerUserData!["email"],
                      Provider.of<MyProvider>(context, listen: false)
                          .peerUserData!["userId"],
